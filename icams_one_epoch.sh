...
#    tt="00:00"
#    dates= $(epoch -d "$epoch + 1 day " +%Y%m%d)
#    echo $dates
#    echo $tt
#else
#    tt="$ttime"
...
#python /work/scratch-pw3/licsar/alejobea/batchdir/LiCSBAS/018A_09021_121620/prueba.py "$icamsout" "$U" "$sltdout"
